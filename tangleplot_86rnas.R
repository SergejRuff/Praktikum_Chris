...
# get path to R-project directory
projectdir <- "A:/Praktikum_Chris/R/code"
...
# I automated the process of creating filefolders where output should be saved
...
# where should all fasta-files be exported to after UTR extraction.
